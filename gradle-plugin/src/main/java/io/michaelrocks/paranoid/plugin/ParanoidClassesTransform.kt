...
import io.michaelrocks.paranoid.processor.StringLiteralsClassPatcher
import io.michaelrocks.paranoid.processor.StringRegistry
import io.michaelrocks.paranoid.processor.StringRegistryImpl
...
abstract class ParanoidClassesTransform :
  ...
  private val deobfuscator: Deobfuscator by lazy {
    ...
    val internalName = "io/michaelrocks/paranoid/Deobfuscator$$projectName"
  ...
  override fun isInstrumentable(classData: ClassData): Boolean {
    return parameters.get().isEnabled.get() &&
      !classData.className.startsWith("io.michaelrocks.paranoid.Deobfuscator")
  }
}
